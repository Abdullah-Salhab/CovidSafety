                          ...
                          children: [
                              ...
                              child: Column(
                                children: [
                                  const Padding(
                                    ...
                                    child: LocaleText("Are you coughing up blood?",
                            ...
                            Container(
                              ...
                              child: MaterialButton(
                                  onPressed: () {
                                    mc.setCoughBlood = "No.";
                                    mc.setMedicalHelpIsNeededCoughBlood = false;
                                  },
                                  child: Row(
                            ...
                            Container(
                              ...
                              child: MaterialButton(
                                  onPressed: () {
                                    mc.setCoughBlood = "Yes.";
                                    mc.setMedicalHelpIsNeededCoughBlood = true;
                                  },
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [
                                  ...
                                  onPressed: () {
                                    if (mc.getCoughBlood != "") {
                                      Navigator.pushReplacement(context,PageTransition(
                                          ...
                                          type: PageTransitionType.size,child: const QuestionNine()),);
                                    }
                                    else{
