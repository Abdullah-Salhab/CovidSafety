...
import 'package:graduation/Daily%20Test/question_twelve.dart';
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: MaterialButton(
                                  onPressed: () {
                                    mc.setCollapse = "No.";
                                    mc.setMedicalHelpIsNeededCollapse = false;
                                  },
                                  child: Row(
                            ...
                            Container(
                              ...
                              child: MaterialButton(
                                  onPressed: () {
                                    mc.setCollapse = "Yes.";
                                    mc.setMedicalHelpIsNeededCollapse = true;
                                  },
                                  child: Row(
                                    mainAxisAlignment: MainAxisAlignment.start,
                                    children: [
                                  ...
                                  onPressed: () {
                                    if (mc.getCollapse != "") {
                                      Navigator.pushReplacement(context,PageTransition(
                                          ...
                                          type: PageTransitionType.size,child:  QuestionTwelve()),);
                                    }
                                    else{
